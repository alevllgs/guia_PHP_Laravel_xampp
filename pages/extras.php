...
$extras = [
    ...
    ['label' => 'Ver info completa de PHP',     'badge' => 'b-blue',   'code' => '<?php phpinfo(); ?>'],
...
<section class="section">
  ...
  <div class="card">
    <div class="card-head">
      <span class="badge b-blue">httpd-vhosts.conf</span>
      <h3>Ejemplo de VirtualHost</h3>
    </div>
...
&lt;/VirtualHost&gt;</pre>
    <div class="tip">
      💡 Agrega también en <code>/etc/hosts</code>:<br>
