...
<section class="hero">
  ...
  <h1>XAMPP + PHP<br><span>Pop!_OS &amp; Windows</span></h1>
...
<div class="section">
  ...
  <div class="g2">
    ...
    foreach ($links as $l): ?>
    <a href="<?= $l['href'] ?>" class="card" style="display:block;text-decoration:none;transition:border-color 0.15s;" onmouseover="this.style.borderColor='var(--border2)'" onmouseout="this.style.borderColor=''">
      <div class="card-head">
